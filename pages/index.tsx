    ...
    <>
      ...
      <main>
        ...
        <div className="hero min-h-screen bg-base-200">
          <div className="hero-content flex-col lg:flex-row space-x-10">
            ...
            <div className="text-center p-8 min-w-fit">
              ...
              <button className="btn btn-outline btn-secondary mr-8">{`About`}</button>
        ...
        <div className="h-screen w-screen flex flex-col space-y-4 items-center justify-center">
          <h1 className="text-6xl text-secondary font-extrabold">Sentence Grinder</h1>
