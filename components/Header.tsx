    ...
    return (
        <div className="navbar bg-base-100">
            ...
            <div className="navbar-start">
                <Dropdown className={"dropdown"}>
                    <label tabIndex={0} className="btn btn-ghost btn-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="hsl(var(--p))" viewBox="0 0 24 24" stroke="hsl(var(--p))"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                    </label>
            ...
            <div className="navbar-end">
                ...
                <Dropdown className="dropdown dropdown-end">
                    <label tabIndex={0} className="btn btn-ghost btn-circle">
                        <i className="bi bi-key link-primary scale-150"></i>
                    </label>

                    {/* Card */}
                    <div className="dropdown-content text-center p-8 rounded-xl shadow-2xl card bg-base-100">
